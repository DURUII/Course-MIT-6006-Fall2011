...
%
Remember, your goal is to communicate. Full credit will be given only to a
correct solution which is described clearly. Convoluted and obtuse descriptions
might receive low marks, even when they are correct. Also, aim for concise
solutions, as it will save you time spent on write-ups, and also help you
conceptualize the key idea of the problem.
...
\begin{problems}
    ...
    \begin{problemparts}
        ...
        \ifsolution \solution{}
            ...
            \sout{\text{3, 4, 1, 2}}; \textcolor{red}{1, 2, 4, 3}
        ...
        \ifsolution \solution{}
            ...
            \sout{\text{2, 3, 4, 1}}; \textcolor{red}{1, 4, 3, 2}
        ...
        \ifsolution \solution{}
            ...
            \sout{\text{1, 2, 3, 4}}; \textcolor{red}{4, 1, 3, 2}
